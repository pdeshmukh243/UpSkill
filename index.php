	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">UpSkill</h1>
			</div>
					...
					<div class="slider-content">
						...
						<div class="text">      <!-- jquery typed effect -->
							...
							<div class="social-networks">
								...
								<a href="https://www.linkedin.com/in/pratik-deshmukh-0b462a1a4/" class="fa fa-linkedin"></a>
					...
					<div class="col-md-12">
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								<img src="img/prats1.jpeg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Pratik Deshmukh</h4>
									<h4 class="team-member-designation">Full Stack Developer</h4>
							...
							<div class="team-member text-center">
								<img src="img/krishnam.jpeg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Krishnam Dongre</h4>
							...
							<div class="team-member text-center">
								<img src="img/sid1.jpeg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Siddhesh Patil</h4>
